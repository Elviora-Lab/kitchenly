...
const CSP = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://connect.facebook.net https://*.facebook.com https://capig.datah04.com https://*.supabase.co https://*.sentry.io https://*.clarity.ms https://c.bing.com",
